    ...
    @if(session('successMessage'))
        ...
        <div class="bg-white rounded-lg shadow p-5 w-full max-w-md mx-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div class="text-center">
                ...
                <div class="mt-8 mb-4">
                    <button id="okBtn" onclick="window.location='{{ route('skills.index', ['month' => session('redirectMonth', now()->format('n月'))]) }}'" class="px-8 py-2 bg-cyan-800 hover:bg-cyan-900 text-white text-base font-medium rounded-md shadow-sm focus:outline-none">
                        編集ページに戻る
                    </button>
                </div>
            </div>
